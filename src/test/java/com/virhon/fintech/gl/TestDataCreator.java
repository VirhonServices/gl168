    ...
    public void generateUahTestData() throws LedgerException, IOException, URISyntaxException {
        ...
        for (Integer i=0;i<count;i++) {
            ...
            for (Integer j=0;j<trCount;j++) {
                ...
                tr = ledger.transferFunds("AUTO-".concat(trRef.toString()), debitAccountUuid, creditAccountUuid,
                                                        amount, repAmount, repDate,"Autogenerated transfer");
            }
        }
        if (tr != null) {
...
// select account_id,uuid,account_number, count(account_id) from uah_account_attribute aa, uah_historical_page h where h.account_id = aa.id group by account_id, uuid, account_number order by 4;
