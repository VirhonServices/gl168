...
public class ReportingPeriodController {
    ...
    public ResponseEntity<?> getReportingBalances(@PathVariable String currencyCode,
        ...
        try {
            ...
            final List<ReportingPeriodResponse.TransferResponse> tResponses = new ArrayList<>();
            collection.getTransfers().forEach(t -> {
                        final ReportingPeriodResponse.TransferResponse trResponse =
                                ReportingPeriodResponse.TransferResponse.createFrom(t);
